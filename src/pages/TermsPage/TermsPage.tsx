...
const TermsPage = () => {
  return (
    <div className={`content-page ${styles['terms-page']}`}>
      <h2>Sample Website Terms and Conditions Template</h2>
      <p>
        Sample Website Terms and Conditions Template Please read these terms and
        conditions ("terms and conditions", "terms") carefully before using
        [website URL] website (“website”, "service") operated by [company name]
        ("us", 'we", "our").
      </p>
      ...
      <p>
        ...
        years of age and you may legally adhere to this Agreement. [company
      ...
      <p>
        ...
        website are the property of [company name], its affiliates, directors,
        ...
        [company name]’s intellectual property in any way, including electronic,
        digital, or new trademark registrations. You grant [company name] a
      ...
      <p>
        ...
        [company name] harmless against legal claims and demands that may arise
        from your use or misuse of our services. We reserve the right to select
        our own legal counsel.{' '}
      </p>
      <h3>Limitation on liability</h3>
      <p>
        [company name] is not liable for any damages that may occur to you as a
        result of your misuse of our website. [company name] reserves the right
        to edit, modify, and change this Agreement at any time. We shall let our
        users know of these changes through electronic mail. This Agreement is
        an understanding between [company name] and the user, and this
        supersedes and replaces all prior agreements regarding the use of this
        website. PRO TIP: Save your time and take the guesswork out of the legal
        jargon with the professional terms and conditions generator trusted by
